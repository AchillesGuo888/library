...
import com.example.library.exception.MyBusinessException;
import java.io.File;
...
public class FileUtil {
  ...
  public static String upload(MultipartFile file) {
    ...
    try {
      ...
      uploadPath.append("/sens/upload/" + DateUtil.thisYear()).append("/")
          .append(DateUtil.thisMonth() + 1).append("/");
      ...
      //不带后缀
      String nameWithOutSuffix = file.getOriginalFilename()
          .substring(0, file.getOriginalFilename().lastIndexOf('.')).replaceAll(" ", "_")
          .replaceAll(",", "");
